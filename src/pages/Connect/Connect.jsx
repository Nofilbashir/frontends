...
const DataForm = () => {
    ...
    const [data,setData]=useState({url:"",curency:"",secretKey:""})
    const{url,curency,secretKey}=data;
  ...
  return (
    <>
      <form className="ConnectContainer">
        <h2>Fill this form to connect your dashboard</h2>
        <div className="FormChild">
          <label htmlFor="url" >Server Url</label>
          <input type="url" id="url" required name="url" placeholder="https://xyz.com/api" value={url} onChange={inputValueupdate}/>
        </div>
        <div className="FormChild">
        ...
        <div className="FormChild">
          ...
          <input type="text" id="secretKey"name="secretKey" placeholder="Secret Key" value={secretKey} onChange={inputValueupdate}/>
        </div>
        <div className="FormChild">
...
function Currency(props) {
  return (
    <>
      <input list="currencysuggestion" id="curency" name="curency" value={props.data.currency} onChange={props.inputValueupdate} placeholder="currency"/>
